      ...
      "ternary operator" - {
        for {
          (expr, kind) <- List(
            ...
            ("a[1:0]?  4'd2 :  2'd3", TypeUInt(4)),
            ("a[1:0]?  4'd2 : 2'sd3", TypeUInt(4)),
            ("a[1:0]? 4'sd2 :  2'd3", TypeUInt(4)),
            ("a[1:0]? 4'sd2 : 2'sd3", TypeSInt(4)),
            ("a[1:0]?  2'd2 :  3'd3", TypeUInt(3)),
            ("a[1:0]?  2'd2 : 3'sd3", TypeUInt(3)),
            ("a[1:0]? 2'sd2 :  3'd3", TypeUInt(3)),
            ("a[1:0]? 2'sd2 : 3'sd3", TypeSInt(3))
          )
        } {
          val text = expr.trim.replaceAll(" +", " ")
          text in {
