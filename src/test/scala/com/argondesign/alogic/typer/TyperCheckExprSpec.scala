    ...
    "index" - {
      for {
        (expr, err) <- List(
          ...
          ("a[bool]", "Index is of non-numeric type" :: Nil),
          ("a[b[0]]", "Index is of non-numeric type" :: Nil),
          ("8'd0[2'd0]", "Index expression yields 2 bits, 3 bits are expected" :: Nil),
          ("8'd0[3'd0]", Nil),
          ("8'd0[4'd0]", "Index expression yields 4 bits, 3 bits are expected" :: Nil),
          ("7'd0[2'd0]", "Index expression yields 2 bits, 3 bits are expected" :: Nil),
          ("7'd0[3'd0]", Nil),
          ("7'd0[4'd0]", "Index expression yields 4 bits, 3 bits are expected" :: Nil),
          ("9'd0[2'd0]", "Index expression yields 2 bits, 4 bits are expected" :: Nil),
          ("9'd0[3'd0]", "Index expression yields 3 bits, 4 bits are expected" :: Nil),
          ("9'd0[4'd0]", Nil),
          ("1'd0[1'd0]", Nil),
          ("1'd0[2'd0]", "Index expression yields 2 bits, 1 bits are expected" :: Nil),
          ("c[2'd3][1'd0][1'd1][2'd2]", Nil),
          ("8'd0[3'sd0]", "Index expression must be unsigned" :: Nil),
        )
      } {
        expr in {
          val root = s"""|fsm f {
    ...
    "slice" - {
      for {
        (expr, err) <- List(
          ...
          ("b[0][1:0]", Nil),
          ("b[0][0][1:0]", Nil),
          ("c[1:0]", "Target of slice is of non-packed type" :: Nil),
          ("c[0][1:0]", Nil),
          ("c[0][0][1:0]", Nil),
          ("c[0][0][0][1:0]", Nil),
          ("bool[1:0]", "Target of slice is of non-packed type" :: Nil),
          ("main[1:0]", "Target of slice is of non-packed type" :: Nil),
          ("a[1:bool]", "Right index expression is of non-numeric type" :: Nil),
          ("a[1:b[0]]", "Right index expression is of non-numeric type" :: Nil),
          ("a[bool:0]", "Left index expression is of non-numeric type" :: Nil),
          ("a[b[0]:0]", "Left index expression is of non-numeric type" :: Nil),
          ("8'd0[3'd1:2'd0]", "Right index expression yields 2 bits, 3 bits are expected" :: Nil),
          ("8'd0[3'd1:3'd0]", Nil),
          ("8'd0[3'd1:4'd0]", "Right index expression yields 4 bits, 3 bits are expected" :: Nil),
          ("7'd0[3'd1:2'd0]", "Right index expression yields 2 bits, 3 bits are expected" :: Nil),
          ("7'd0[3'd1:3'd0]", Nil),
          ("7'd0[3'd1:4'd0]", "Right index expression yields 4 bits, 3 bits are expected" :: Nil),
          ("9'd0[4'd1:2'd0]", "Right index expression yields 2 bits, 4 bits are expected" :: Nil),
          ("9'd0[4'd1:3'd0]", "Right index expression yields 3 bits, 4 bits are expected" :: Nil),
          ("9'd0[4'd1:4'd0]", Nil),
          ("8'd0[2'd1:3'd0]", "Left index expression yields 2 bits, 3 bits are expected" :: Nil),
          ("8'd0[4'd1:3'd0]", "Left index expression yields 4 bits, 3 bits are expected" :: Nil),
          ("7'd0[2'd1:3'd0]", "Left index expression yields 2 bits, 3 bits are expected" :: Nil),
          ("7'd0[4'd1:3'd0]", "Left index expression yields 4 bits, 3 bits are expected" :: Nil),
          ("9'd0[2'd1:4'd0]", "Left index expression yields 2 bits, 4 bits are expected" :: Nil),
          ("9'd0[3'd1:4'd0]", "Left index expression yields 3 bits, 4 bits are expected" :: Nil),
          ("9'd0[4'sd1:4'd0]", "Index expression must be unsigned" :: Nil),
          ("9'd0[4'd1:4'sd0]", "Index expression must be unsigned" :: Nil)
        )
      } {
        expr in {
          val root = s"""|fsm f {
