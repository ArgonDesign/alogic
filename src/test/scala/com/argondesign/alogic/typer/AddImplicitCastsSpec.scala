  ...
  "AddImplicitCasts should automatically insert casts" - {
    "to infer sizes of unsized literals in" - {
        ...
        for (op <- List("*", "/", "%", "+", "-", "&", "|", "^", ">", ">=", "<", "<=", "==", "!=")) {
          for {
            (text, res) <- List(
              ...
              (s"8'd3 ${op} -'sd2", Some(Right(ExprCast(TypeUInt(8), ExprNum(true, -2))))),
              (s"-'sd2 ${op} 8'd3", Some(Left(ExprCast(TypeUInt(8), ExprNum(true, -2))))),
              (s"7'sd3 ${op} 2", Some(Right(ExprCast(TypeSInt(7), 2)))),
              (s"2 ${op} 7'sd3", Some(Left(ExprCast(TypeSInt(7), 2)))),
              (s"7'sd3 ${op} -'sd2", Some(Right(ExprCast(TypeSInt(7), ExprNum(true, -2))))),
              (s"-'sd2 ${op} 7'sd3", Some(Left(ExprCast(TypeSInt(7), ExprNum(true, -2))))),
              (s"4 ${op} 2 ", None)
            )
          } {
            text in {
      ...
      "ternary operator operands" - {
        for {
          (text, res) <- List(
            ...
            ("0 ? 0 : 3'sd1", Some(Left(ExprCast(TypeSInt(3), 0)))),
            ("0 ? 3'sd1 : 0", Some(Right(ExprCast(TypeSInt(3), 0)))),
            ("0 ? 1 : 0", None)
          )
        } {
          text in {
      ...
      "index expressions" - {
        ...
        for {
          (index, res) <- List(
            ...
            ("u32[8] a; (* unused *) u1 b = a[0][2]",
             List(ExprCast(TypeUInt(5), 2), ExprCast(TypeUInt(3), 0))),
            ("u33[9] a; (* unused *) u1 b = a[0][2]",
             List(ExprCast(TypeUInt(6), 2), ExprCast(TypeUInt(4), 0))),
          )
        } {
          index in {
            val entity = s"""|fsm f {
      ...
      "slice expressions" - {
        ...
        for {
          (slice, res) <- List(
            ("u8 a; (* unused *) u2 b = a[1:0]",
             List((ExprCast(TypeUInt(3), 1), ExprCast(TypeUInt(3), 0)))),
            ("u9 a; (* unused *) u2 b = a[1:0]",
             List((ExprCast(TypeUInt(4), 1), ExprCast(TypeUInt(4), 0)))),
            ("u8 a; (* unused *) u1 b = a[2+:1]",
             List((ExprCast(TypeUInt(3), 2), ExprCast(TypeUInt(3), 1)))),
            ("u9 a; (* unused *) u1 b = a[2+:1]",
             List((ExprCast(TypeUInt(4), 2), ExprCast(TypeUInt(4), 1)))),
            ("u8 a; (* unused *) u1 b = a[2-:1]",
             List((ExprCast(TypeUInt(3), 2), ExprCast(TypeUInt(3), 1)))),
            ("u9 a; (* unused *) u1 b = a[2-:1]",
             List((ExprCast(TypeUInt(4), 2), ExprCast(TypeUInt(4), 1)))),
            ("u32[8] a; (* unused *) u2 b = a[1:0]",
             List((ExprCast(TypeUInt(3), 1), ExprCast(TypeUInt(3), 0)))),
            ("u33[9] a; (* unused *) u2 b = a[1:0]",
             List((ExprCast(TypeUInt(4), 1), ExprCast(TypeUInt(4), 0)))),
            ("u32[8] a; (* unused *) u1 b = a[2+:1]",
             List((ExprCast(TypeUInt(3), 2), ExprCast(TypeUInt(3), 1)))),
            ("u33[9] a; (* unused *) u1 b = a[2+:1]",
             List((ExprCast(TypeUInt(4), 2), ExprCast(TypeUInt(4), 1)))),
            ("u32[8] a; (* unused *) u1 b = a[2-:1]",
             List((ExprCast(TypeUInt(3), 2), ExprCast(TypeUInt(3), 1)))),
            ("u33[9] a; (* unused *) u1 b = a[2-:1]",
             List((ExprCast(TypeUInt(4), 2), ExprCast(TypeUInt(4), 1)))),
//            ("u32[8] a; (* unused *) u2 b = a[5:0][3:2]",
//             List((ExprCast(TypeUInt(5), 5), ExprCast(TypeUInt(5), 0)),
//                  (ExprCast(TypeUInt(4), 3), ExprCast(TypeUInt(3), 1)))),
//            ("u33[9] a; (* unused *) u2 b = a[5:0][3:2]",
//             List((ExprCast(TypeUInt(6), 5), ExprCast(TypeUInt(6), 0)),
//                  (ExprCast(TypeUInt(4), 3), ExprCast(TypeUInt(4), 1)))),
//            ("u32[8] a; (* unused *) u2 b = a[2+:1][3:2]",
//             List((ExprCast(TypeUInt(5), 1), ExprCast(TypeUInt(5), 1)),
//                  (ExprCast(TypeUInt(3), 1), ExprCast(TypeUInt(3), 1)))),
//            ("u33[9] a; (* unused *) u2 b = a[2+:1][3:2]",
//             List((ExprCast(TypeUInt(6), 1), ExprCast(TypeUInt(6), 1)),
//                  (ExprCast(TypeUInt(4), 1), ExprCast(TypeUInt(4), 1)))),
//            ("u32[8] a; (* unused *) u2 b = a[2-:1][3:2]",
//             List((ExprCast(TypeUInt(5), 1), ExprCast(TypeUInt(5), 1)),
//                  (ExprCast(TypeUInt(3), 1), ExprCast(TypeUInt(3), 1)))),
//            ("u33[9] a; (* unused *) u2 b = a[2-:1][3:2]",
...
//                  (ExprCast(TypeUInt(4), 1), ExprCast(TypeUInt(4), 1)))),
      ...
      "right hand sides of assignments" - {
        for {
          (assign, res) <- List(
            ("i8 a = 0; a = 'sd2", ExprCast(TypeSInt(8), ExprNum(true, 2))),
            ("u8 a = 0; a = 'sd2", ExprCast(TypeUInt(8), ExprNum(true, 2))),
            ("i7 a = 0; a = 2", ExprCast(TypeSInt(7), ExprNum(false, 2))),
