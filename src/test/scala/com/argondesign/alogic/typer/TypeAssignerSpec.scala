      ...
      "binary operators" - {
        for {
          (expr, kind) <- List(
            ...
            ("32'd1 ||  32'd1s", TypeUInt(1)),
            // signed unsigned
            ("32'd1s *   32'd1", TypeUInt(32)),
            ("32'd1s /   32'd1", TypeUInt(32)),
            ("32'd1s %   32'd1", TypeUInt(32)),
            ("32'd1s +   32'd1", TypeUInt(32)),
            ("32'd1s -   32'd1", TypeUInt(32)),
            ("32'd1s <<  32'd1", TypeSInt(32)),
            ("32'd1s >>  32'd1", TypeSInt(32)),
            ("32'd1s >>> 32'd1", TypeSInt(32)),
            ("32'd1s <<< 32'd1", TypeSInt(32)),
            ("32'd1s >   32'd1", TypeUInt(1)),
            ("32'd1s >=  32'd1", TypeUInt(1)),
            ("32'd1s <   32'd1", TypeUInt(1)),
            ("32'd1s <=  32'd1", TypeUInt(1)),
            ("32'd1s ==  32'd1", TypeUInt(1)),
            ...
            ("3'd1 >>> 32'd1", TypeUInt(3)),
            ("3'd1 <<< 32'd1", TypeUInt(3)),
            ("3'd1 <<  32'd1s", TypeUInt(3)),
            ("3'd1 >>  32'd1s", TypeUInt(3)),
            ("3'd1 >>> 32'd1s", TypeUInt(3)),
            ("3'd1 <<< 32'd1s", TypeUInt(3)),
            ("3'd1s <<  32'd1", TypeSInt(3)),
            ("3'd1s >>  32'd1", TypeSInt(3)),
            ("3'd1s >>> 32'd1", TypeSInt(3)),
            ("3'd1s <<< 32'd1", TypeSInt(3)),
            ("3'd1s <<  32'd1s", TypeSInt(3)),
            ("3'd1s >>  32'd1s", TypeSInt(3)),
            ("3'd1s >>> 32'd1s", TypeSInt(3)),
            ("3'd1s <<< 32'd1s", TypeSInt(3)),
            // Widening
      ...
      "ternary operator" - {
        for {
          (expr, kind) <- List(
            ...
            ("a[1:0]?  5'd2 : 5'd3s", TypeUInt(5)),
            ("a[1:0]? 5'd2s :  5'd3", TypeUInt(5)),
            ("a[1:0]? 5'd2s : 5'd3s", TypeSInt(5)),
            ("a[1:0]?  4'd2 :  2'd1", TypeUInt(4)),
            ("a[1:0]?  4'd2 : 2'd1s", TypeUInt(4)),
            ("a[1:0]? 4'd2s :  2'd1", TypeUInt(4)),
            ("a[1:0]? 4'd2s : 2'd1s", TypeSInt(4)),
            ("a[1:0]?  2'd1 :  3'd3", TypeUInt(3)),
            ("a[1:0]?  2'd1 : 3'd3s", TypeUInt(3)),
            ("a[1:0]? 2'd1s :  3'd3", TypeUInt(3)),
            ("a[1:0]? 2'd1s : 3'd3s", TypeSInt(3)),
            // Unsized
            ("a[1:0]?  'd2 :  'd3", TypeNum(false)),
            ("a[1:0]?  'd2 : 'd3s", TypeNum(false)),
            ("a[1:0]? 'd2s :  'd3", TypeNum(false)),
            ("a[1:0]? 'd2s : 'd3s", TypeNum(true))
          )
        } {
          val text = expr.trim.replaceAll(" +", " ")
          text in {
      ...
      "cat" - {
        for {
          (expr, kind) <- List(
            ...
            ("{  3'd0, 4'd0s }", TypeUInt(7)),
            ("{ 3'd0s,  4'd0 }", TypeUInt(7)),
            ("{ 3'd0s, 4'd0s }", TypeUInt(7))
          )
        } {
          val text = expr.trim.replaceAll(" +", " ")
          text in {
