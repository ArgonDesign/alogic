    ...
    "unary operators over unsized constants" - {
      for {
        (expr, width, result) <- List(
          ...
          (s"-(0)", 8, ExprUnary("-", ExprInt(false, 8, 0))),
          (s"~(0)", 8, ExprUnary("~", ExprInt(false, 8, 0))),
          (s"+('sd0)", 8, ExprUnary("+", ExprInt(true, 8, 0))),
          (s"-('sd0)", 8, ExprUnary("-", ExprInt(true, 8, 0))),
          (s"~('sd0)", 8, ExprUnary("~", ExprInt(true, 8, 0)))
        )
      } {
    ...
    "binary operators over unsized constants" - {
      for {
        (expr, width, result) <- List(
          ...
          ("1   | 2", 8, ExprInt(false, 8, 1) | ExprInt(false, 8, 2)),
          // unsigned signed
          ("1   * 'sd2", 8, ExprInt(false, 8, 1) * ExprInt(true, 8, 2)),
          ("1   / 'sd2", 8, ExprInt(false, 8, 1) / ExprInt(true, 8, 2)),
          ("1   % 'sd2", 8, ExprInt(false, 8, 1) % ExprInt(true, 8, 2)),
          ("1   + 'sd2", 8, ExprInt(false, 8, 1) + ExprInt(true, 8, 2)),
          ("1   - 'sd2", 8, ExprInt(false, 8, 1) - ExprInt(true, 8, 2)),
          ("1  << 'sd2", 8, ExprInt(false, 8, 1) << ExprNum(true, 2)),
          ("1  >> 'sd2", 8, ExprInt(false, 8, 1) >> ExprNum(true, 2)),
          ("1 <<< 'sd2", 8, ExprInt(false, 8, 1) <<< ExprNum(true, 2)),
          ("1 >>> 'sd2", 8, ExprInt(false, 8, 1) >>> ExprNum(true, 2)),
          ("1   & 'sd2", 8, ExprInt(false, 8, 1) & ExprInt(true, 8, 2)),
          ...
          ("1   | 'sd2", 8, ExprInt(false, 8, 1) | ExprInt(true, 8, 2)),
          // signed unsigned
          ("'sd1   * 2", 8, ExprInt(true, 8, 1) * ExprInt(false, 8, 2)),
          ("'sd1   / 2", 8, ExprInt(true, 8, 1) / ExprInt(false, 8, 2)),
          ("'sd1   % 2", 8, ExprInt(true, 8, 1) % ExprInt(false, 8, 2)),
          ("'sd1   + 2", 8, ExprInt(true, 8, 1) + ExprInt(false, 8, 2)),
          ("'sd1   - 2", 8, ExprInt(true, 8, 1) - ExprInt(false, 8, 2)),
          ("'sd1  << 2", 8, ExprInt(true, 8, 1) << ExprNum(false, 2)),
          ("'sd1  >> 2", 8, ExprInt(true, 8, 1) >> ExprNum(false, 2)),
          ("'sd1 <<< 2", 8, ExprInt(true, 8, 1) <<< ExprNum(false, 2)),
          ("'sd1 >>> 2", 8, ExprInt(true, 8, 1) >>> ExprNum(false, 2)),
          ("'sd1   & 2", 8, ExprInt(true, 8, 1) & ExprInt(false, 8, 2)),
          ...
          ("'sd1   | 2", 8, ExprInt(true, 8, 1) | ExprInt(false, 8, 2)),
          // signed signed
          ("'sd1   * 'sd2", 8, ExprInt(true, 8, 1) * ExprInt(true, 8, 2)),
          ("'sd1   / 'sd2", 8, ExprInt(true, 8, 1) / ExprInt(true, 8, 2)),
          ("'sd1   % 'sd2", 8, ExprInt(true, 8, 1) % ExprInt(true, 8, 2)),
          ("'sd1   + 'sd2", 8, ExprInt(true, 8, 1) + ExprInt(true, 8, 2)),
          ("'sd1   - 'sd2", 8, ExprInt(true, 8, 1) - ExprInt(true, 8, 2)),
          ("'sd1  << 'sd2", 8, ExprInt(true, 8, 1) << ExprNum(true, 2)),
          ("'sd1  >> 'sd2", 8, ExprInt(true, 8, 1) >> ExprNum(true, 2)),
          ("'sd1 <<< 'sd2", 8, ExprInt(true, 8, 1) <<< ExprNum(true, 2)),
          ("'sd1 >>> 'sd2", 8, ExprInt(true, 8, 1) >>> ExprNum(true, 2)),
          ("'sd1   & 'sd2", 8, ExprInt(true, 8, 1) & ExprInt(true, 8, 2)),
