    ...
    "binary operators applied to unsized integer literals" - {
      for {
        (text, result, err) <- List(
          ...
          (" 3s - 2", ExprNum(false, 1), Nil),
          (" 3s - 4", ExprError(), "Result of operator '-' is unsigned, but value is negative" :: Nil),
          ("-3s * 2", ExprError(), "Result of operator '*' is unsigned, but value is negative" :: Nil),
          ("-3s / 2", ExprError(), "Result of operator '/' is unsigned, but value is negative" :: Nil),
          ("-3s % 2", ExprError(), "Result of operator '%' is unsigned, but value is negative" :: Nil),
          ("-3s + 2", ExprError(), "Result of operator '+' is unsigned, but value is negative" :: Nil),
          ("-3s - 2", ExprError(), "Result of operator '-' is unsigned, but value is negative" :: Nil),
          ...
          ("3 -  2s", ExprNum(false, 1), Nil),
          ("3 -  4s", ExprError(), "Result of operator '-' is unsigned, but value is negative" :: Nil),
          ("3 * -2s", ExprError(), "Result of operator '*' is unsigned, but value is negative" :: Nil),
          ("3 / -2s", ExprError(), "Result of operator '/' is unsigned, but value is negative" :: Nil),
          ("3 % -2s", ExprNum(false, 1), Nil),
          ("3 + -2s", ExprNum(false, 1), Nil),
          ("3 - -2s", ExprNum(false, 5), Nil),
          ...
          ("3 - 2", ExprNum(false, 1), Nil),
          ("3 - 4", ExprError(), "Result of operator '-' is unsigned, but value is negative" :: Nil),
          // Shifts
